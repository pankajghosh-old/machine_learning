...
class Sigmoid:
    ...
    def logistic_function(self, input):
        return 1/ (1 + np.exp(-input))
    
    def d_logistic_function(self, input):
        return self.logistic_function(input)*(1-self.logistic_function(input))
    ...
    def activate(self, values):
        ...
        result = self.logistic_function(strength)
        return result
    ...
    def update(self, values, train, eta=.1):
        ...
        for X, y_true in zip(values, train):
            ...
            change = eta * (y_pred - y_true) * X * y_pred * (1-y_pred)
